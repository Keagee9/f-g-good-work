...
export const serviceCategories: ServiceCategory[] = [
  ...
  },
  {
    "id": "cat_005",
    "name": "Sew-ins",
    "image": "https://picsum.photos/seed/sewin/400/400",
    "variants": [
      {
        "id": "var_016",
        ...
        "duration": "2.5 hours",
        "price": 200,
        "description": "Classic sew-in with leave-out for a natural blend."
      },
      {
        "id": "var_017",
        "name": "Versatile Sew-in",
        "duration": "3 hours",
        "price": 250,
        "description": "Allows for multiple parting options and high ponytails."
      },
      {
        "id": "var_018",
        ...
        "duration": "3 hours",
        "price": 280,
        "description": "Full coverage sew-in with a lace closure for a flawless finish."
      }
    ]
  },
  {
    "id": "cat_006",
    "name": "Microlinks/I-Tips",
    "image": "https://picsum.photos/seed/microlinks/400/400",
    "variants": [
      {
        "id": "var_019",
        "name": "Microlink Installation (Full Head)",
        "duration": "4 hours",
        "price": 400,
        "description": "Individual strand-by-strand installation for maximum versatility."
      },
      {
        "id": "var_020",
        ...
        "duration": "1.5 hours",
        "price": 150,
        "description": "Tightening and repositioning of existing microlinks."
      }
    ]
  },
  {
    "id": "cat_007",
    "name": "Tape-ins",
    "image": "https://picsum.photos/seed/tapein/400/400",
    "variants": [
      {
        "id": "var_021",
        "name": "Tape-in Installation",
        "duration": "2 hours",
        "price": 250,
        "description": "Seamless tape-in extensions for added volume and length."
      },
      {
        "id": "var_022",
        "name": "Tape-in Removal & Re-application",
        "duration": "2.5 hours",
        "price": 300,
        "description": "Safe removal and re-installation of tape-in extensions."
      }
    ]
  },
  {
    "id": "cat_008",
    "name": "Quick Weaves",
    "image": "https://picsum.photos/seed/quickweave/400/400",
    "variants": [
      {
        "id": "var_023",
        "name": "Quick Weave Bob",
        "duration": "1.5 hours",
        "price": 120,
        "description": "A chic and stylish bob created using a quick weave technique."
      },
      {
        "id": "var_024",
        ...
        "duration": "2 hours",
        "price": 150,
        "description": "A fast and fabulous weave with a natural leave-out."
      }
    ]
  }
];
